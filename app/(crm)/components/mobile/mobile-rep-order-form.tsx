...
export default function MobileRepOrderForm() {
  ...
  const [repRegionName, setRepRegionName] = useState("");
  const [repStockLocationId, setRepStockLocationId] = useState("");
  const [repStockLocationName, setRepStockLocationName] = useState("");
  ...
  return (
    <div style={{ display: "grid", gap: 16 }}>
          ...
          {selectedClient ? (
            ...
            >
              ...
              <div style={{ fontSize: 12, color: colors.subtext }}>
                Região: {repRegionName || selectedClient.region?.name || "Sem região"}
              </div>
            </div>
          ) : null}
        </div>
      ...
      <MobileCard>
        ...
        >
          {repStockLocationName || "Estoque não vinculado"}
        </div>
        ...
        >
          Estoque definido automaticamente pela região do representante.
        </div>
      </MobileCard>
