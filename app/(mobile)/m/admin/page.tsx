    ...
    >
      {loading ? (
        ...
        <>
          ...
          <MobileCard>
            <MobileSectionTitle title="Novo cadastro / novo lançamento" />
            <div
              style={{
                display: "grid",
                gridTemplateColumns: "repeat(2, minmax(0,1fr))",
            ...
            >
              <QuickCard
                ...
                title="Novo cliente"
                description="Cadastrar um novo cliente agora."
              />
              <QuickCard
                href="/m/admin/exhibitors/new"
                icon={<Store size={18} />}
                title="Novo expositor"
                description="Cadastrar um novo expositor."
              />
              <QuickCard
                href="/m/admin/orders/new"
                icon={<PlusCircle size={18} />}
                title="Novo pedido"
                description="Abrir um novo pedido no mobile."
              />
            </div>
          </MobileCard>
