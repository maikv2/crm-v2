...
export async function GET() {
  try {
    ...
    const regionMap = new Map<
      string,
      { regionName: string; totalCents: number; ordersCount: number }
    >();
    ...
    const clientMap = new Map<string, { clientName: string; totalCents: number }>();
    ...
    const productMap = new Map<string, { productName: string; qty: number }>();
    ...
    const monthMap = new Map<string, { key: string; label: string; totalCents: number }>();
